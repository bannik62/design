...
window.addEventListener("scroll", function () {
  ...
  if (scrollPosition > 1500 && scrollPosition < 1520) {
    console.log("1500");
    arrow();
...
window.addEventListener("resize", function () {
  ...
  let leftOffset =
    parseFloat(document.getElementById("buttonCv").style.left) || 0;
  ...
  let currentWidth =
    parseFloat(document.getElementById("buttonCv").style.width) || elementWidth;
...
if (typeof screenWidth !== "undefined" && screenWidth !== null) {
...
// Fonction pour vérifier si la séquence de touches est le Konami Code
